...
struct MferSlotMachine: View {
  ...
  private let nounComposer: NounComposer = AppCore.shared.mferComposer
  ...
  var body: some View {
    ZStack(alignment: .bottom) {
      ...
      ZStack(alignment: .top) {
        ForEach(MferSlotMachine.TraitType.layeredOrder, id: \.self) { type in
          MferSlotMachine.Segment(
            seed: $seed,
            type: type,
