...
extension MferSlotMachine.TraitType {
  
  private var composer: NounComposer {
    AppCore.shared.mferComposer
  }
  ...
  static let layeredOrder: [MferSlotMachine.TraitType] = [.background, .smoke, .head, .beard, .chain, .eyes, .longHair, .shortHair, .hatUnderHeadphones, .headphones, .hatOverHeadphones, .mouth, .watch, .shirt]
